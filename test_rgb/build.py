...
cSourceList.append(projfile.ProjectFile("rgb.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("rgb/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("rgb/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("rgb/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("rgb/tpl_interrupts.c"))
...
if True:
  postCommand = makefile.PostCommand("Generating binary trampuinoBlink.hex from trampuinoBlink")
  postCommand.mCommand.append(r"avr-objcopy")
  postCommand.mCommand += "-O ihex".split()
  postCommand.mCommand.append("trampuinoBlink")
  postCommand.mCommand.append("trampuinoBlink.hex")
...
if make.errorCount() == 0:
  if askedGoal == "flash" :
    ...
    commandLine += "trampuinoBlink.hex "
    ...
    if makefile.find_executable("avrdude") != None:
      print("\033[1m\033[95mFlashing trampuinoBlink on avr/arduino/uno\033[0m")
