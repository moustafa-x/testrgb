...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file rgb.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/uno --templates=../../../../goil/templates/ rgb.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("rgb/tpl_app_config.c")

sourceList.append("rgb/tpl_dispatch_table.c")
sourceList.append("rgb/tpl_invoque.S")
sourceList.append("rgb/tpl_interrupts.c")
